  ...
  getFormattedCard() {
    ...
    switch (this.faceValue) {
      ...
      case 12:
        ...
        break;
      default:
        throw new Error("Something went wrong " + this.faceValue + " is not a valid faceValue!");
    }
    ...
    switch (this.suit) {
      ...
      case 3:
        ...
        break;
      default:
        throw new Error("Something went wrong " + this.suit + " is not a valid suitName!");
    }
...
//print out an object //Card { suit: 'hearts', value: 6 }
